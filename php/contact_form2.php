...
$usermail = $_POST['cd-email'];
$username = $_POST['cd-name'];
$usercompany = $_POST['cd-company'];
$content  = nl2br($_POST['cd-textarea']);
...
$msg .= "<p><strong>Номер телефона:</strong> ".$usercompany."</p>\r\n";
